...
import 'package:airportshuttle4less/core/utils/app_lotties/app_lotties.dart';
...
class AppButton extends StatelessWidget {
  ...
  /// Optional custom background color. If null, uses default colors based on [primary] and [onPressed] state.
  final Color? backgroundColor;

  /// Whether to show border when [primary] is false. Defaults to true.
