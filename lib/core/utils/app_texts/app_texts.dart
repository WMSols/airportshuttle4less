class AppTexts {
  ...
  // App Info
  static const String appName = "AirportShuttles4Less";
  static const String appTagline = "Your Reliable Airport Shuttle Service";
  static const String appVersion = "Version 1.0.0";

  // Onboarding
  static const String onBoardingTitle1 = "Book Your Shuttle";
  static const String onBoardingSubtitle1 =
      "Find and book airport shuttle rides easily with just a few taps.";
  static const String onBoardingTitle2 = "Choose Your Vehicle";
  static const String onBoardingSubtitle2 =
      "Select from a variety of vehicles to suit your needs.";
  static const String onBoardingTitle3 = "Secure Payment";
  static const String onBoardingSubtitle3 =
      "Pay securely online and get instant confirmation.";
  ...
  static const String noConnection = "No InternetConnection";
  static const String emailRequired = "Please enter your email";
  static const String validEmailRequired = "Please enter a valid email";
  static const String emailTooShort = "Email is too short";
  static const String emailTooLong = "Email is too long";
  static const String emailNoSpaces = "Email cannot contain spaces";
  ...
  static const String couldNotSendResetLink =
      "Could not send reset link. Please try again.";
  static const String forgotPasswordTitle = "Forgot Password";
  static const String forgotPasswordSubtitle =
      "Enter your email to reset your password";
  static const String resetPassword = "Reset Password";
  static const String enterNumberOfHours = "Enter number of hours";
  static const String enterNumberOfPassengers = "Enter number of passengers";
  ...
  static const String selectPickupLocation = "Select Pickup Location";
  ...
  static const String availableVehicles = "Available Vehicles";
  ...
  static const String bookAnotherRide = "Book Another Ride";
  ...
  // Profile
  static const String unableToLoadProfile =
  ...
  static const String sendMessageNow = "SEND MESSAGE NOW";
  static const String smsConsentContact =
      "By checking this box, you agree to receive conversational SMS messages from Airport Shuttle 4 Less related to Appointment reminders, Follow-up messages. You may reply STOP to opt out at any time. Reply HELP to (443) 336-3333 for assistance. Messages and data rates may apply. Message frequency will vary. Learn more on our Privacy Policy page and Terms & Conditions.";
  static const String smsConsentQuote =
      "By checking this box, you agree to receive conversational SMS messages from Airport Shuttle 4 Less related to Appointment reminders, Follow-up messages. You may reply STOP to opt out at any time. Reply HELP to (443) 336-3333 for assistance. Messages and data rates may apply. Message frequency will vary. Learn more on our Privacy Policy page and Terms & Conditions.";
  static const String smsConsentRequired =
      "Please accept the SMS consent to continue.";
  static const String typeOfService = "Type of Service";
  static const String vehicleTypes = "Vehicle Types";
  static const String destination = "Destination";
  static const String hours = "Hours";
  static const String addMessageOptional = "Add a message or note (optional)";
  static const String getYourQuote = "GET YOUR QUOTE";
  static const String personalizedQuoteRequest = "Personalized Quote Request";
  static const String quoteRequestHint =
      "Submit your details for a custom quote. Our team will review and get back to you promptly.";
  static const String instantPricingPrompt =
      "If you prefer instant pricing and immediate reservations, please click here.";
  static const String clickHere = "click here";
  static const String selectDate = "Select date";
  static const String selectTime = "Select time";
  static const String datePlaceholder = "dd/mm/yyyy";
  static const String timePlaceholder = "Select time";
  static const String messageSentSuccess = "Your message has been sent!";
  static const String quoteRequestSuccess =
  ...
  static const String enterPickupAddress = "Enter pickup address";
  ...
  static const String todayShopsHint = "Today's shops will appear here";

  // Reviews (Comments) – shown in Profile
  static const String reviews = "Reviews";
  static const String reviewsSubtitle =
      "See what others say and leave your review";
  static const String leaveReview = "Leave a Review";
  static const String leaveReviewSubtitle = "Share your experience with us";
  static const String yourReview = "Your Review";
  static const String noReviewsYet =
      "No reviews yet. Be the first to leave one!";
  static const String reviewSubmitted =
      "Your review has been submitted. Thank you!";
  static const String reviewDeleted = "Review deleted";
  static const String deleteReview = "Delete review";
  static const String submitReview = "Submit Review";
  static const String reviewDate = "Date";

  // Support (shown in Profile)
  static const String contactUs = "Contact Us";
  static const String contactUsSubtitle = "Get in touch with our support team";
  static const String contactPhone = "1-443-336-3333";
  static const String contactEmail = "Info@airportshuttles4less.com";
  ...
  static const String corporateQuote = "Corporate Quotes";
  static const String corporateQuoteSubtitle =
      "Request a quote for your company";
  static const String corporateQuoteHeading =
      "Get a Custom Quote for Your Business";
  static const String corporateQuoteHint =
      "Fill out the form below and we will get back to you within 24 hours.";
  static const String companyName = "Company Name";
  static const String businessRequirements = "Business Requirements";
  static const String businessRequirementsHint =
      "Describe your transportation needs...";
  static const String requestQuote = "Request Quote";

  // Legal (Terms & Privacy)
  static const String termsAndConditions = "Terms & Conditions";
  static const String termsAndConditionsSubtitle =
